            ...
            <div class="row">
                <div class="col-sm-6 checkoutForms">
                    ...
                    <div class="col-lg-12 noPadding loginss">
                        <input type="checkbox" name="logins" value="1" /><span>Create Account ? or Sign in with &nbsp;<a
                                href="#" class="facs"><i class="fa fa-facebook-square"></i></a> <a href="#"
                                class="goos"><i class="fa fa-google-plus-square"></i></a></span>
                    </div>
                    <div class="clearfix"></div>
                    <h4 class="comonHeading">Ship to Alternative Address ?<input type="checkbox" name="check_altr" />
                    </h4>
                    <div class="col-lg-12 noPadding">
                            ...
                            <div id="payment" class="woocommerce-checkout-payment">
                                <ul class="wc_payment_methods payment_methods methods">
                                    ...
                                    <li class="wc_payment_method payment_method_paypal">
                                        ...
                                        <label for="payment_method_paypal"> PayPal <img src="img/payment.jpg"
                                                alt="PayPal"></label>
